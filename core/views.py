...
This maintains backward compatibility with existing imports while eliminating code duplication.
"""

# Import all view definitions from modular view files

# Home view
from .views.post_views import home
...
# Search views
from .views.search_views import search, advanced_search
...
# Utility views
from .views.utils_views import sentry_status, sentry_test